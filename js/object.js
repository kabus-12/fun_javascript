...
const hwang = new Student("11-3", "황길동", "2006-08-04"); //인스턴스 생성
...
Date.prototype.toLocalFormat = function () {
  ...
  return `${yyyy}-${("0" + mm).slice(-2)}-${dd} ${("0" + hh).slice(-2)}:${("0" + mi).slice(-2)}:${("0" + ss).slice(-2)}`;
}; //2026-04-02 13:22:34 포멧.
